...
public class RunServiceImpl implements RunService {
    ...
    public RunResults runMain(ExternalCode code)
        ...
        String[] classes = {path};
        return runCore.runMethod(classes, PreProcessors.singleClass, "main", Runners.main, ResultsProcessors.main);
    }
    ...
    public RunResults runLesson(int courseId, int lessonNumber)
        ...
        return runCore.runMethod(classPaths, PreProcessors.lessons, "main", Runners.main, ResultsProcessors.main);
    }
    ...
    public RunResults runLessonWithSolution(int courseId, int lessonNumber, ExternalCode code)
        ...
        RunResults results = runCore.runMethod(classPaths, PreProcessors.lessons, "main", Runners.main,
