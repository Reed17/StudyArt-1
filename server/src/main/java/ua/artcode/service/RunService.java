...
public interface RunService {
    ...
    RunResults runBaseLessonWithSolutionTests(int lessonId, String classText, Integer userId) throws IOException, NoSuchMethodException, IllegalAccessException, ClassNotFoundException;
}
